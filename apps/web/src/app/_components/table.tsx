...
export function ProductsTable() {
	...
	const limit = 50
	const { data, fetchNextPage, hasNextPage, isFetchingNextPage } = trpc.getAllProducts.useInfiniteQuery({ limit: limit },
		{
...
useEffect(() => {
    ...
    if (lastVirtualItemIndex > triggerThreshold) {
        console.log('--- Triggering fetchNextPage via virtualizer proximity ---');
        console.log(`Condition: ${lastVirtualItemIndex} > ${triggerThreshold}`);
        fetchNextPage();
    }
}, [
	hasNextPage,
